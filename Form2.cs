...
namespace AngelBot
{
    public partial class waypointeditor : Form
    {
        ...
        List<string> gatheringlist = new List<string>();
        ...
        {
            foreach (string gather in gatheringlist)
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                gatheringlist.Clear();
                foreach (string newg in listBox2.Items)
                {
                    gatheringlist.Add(newg);
                }
            }
